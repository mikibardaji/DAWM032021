...
public class CardCollection {
    ...
    private Album dragon_ball; //Objeto DAO
    ...
    private void runApp() {
        ...
        dragon_ball = new Album(num_cromos); //creo objeto DAo informando 
        //el numero de cromos que hay en la colección
        main_menu = new Menu("Coleccion de cromos Dragon Ball");
        addOptions();
        testCards(); //cromos de muestra
        int option;
        do {
